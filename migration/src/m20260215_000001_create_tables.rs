...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        // Collections table
        tables.push(manager.create_table(
            Table::create()
                .table(Collection::Table)
                .if_not_exists()
                .col(ColumnDef::new(Collection::Id).integer().auto_increment().primary_key())
                .col(ColumnDef::new(Collection::Title).string().not_null())
                .col(ColumnDef::new(Collection::Description).string())
                .col(ColumnDef::new(Collection::CreatedAt).timestamp_with_time_zone().not_null())
                .col(ColumnDef::new(Collection::UpdatedAt).timestamp_with_time_zone().not_null())
                .index(Index::create().name("idx_collection_title").col(Collection::Title))
                .index(Index::create().name("idx_collection_created_at").col(Collection::CreatedAt))
                .to_owned(),
        ).await?);
        ...
        tables.push(manager.create_table(
            Table::create()
                .table(Text::Table)
                .if_not_exists()
                .col(ColumnDef::new(Text::Id).integer().auto_increment().primary_key())
                .col(ColumnDef::new(Text::Content).string().not_null())
                .col(ColumnDef::new(Text::Kind).string().not_null())
                .col(ColumnDef::new(Text::CreatedAt).timestamp_with_time_zone().not_null())
        ...
        tables.push(manager.create_table(
            Table::create()
                .table(File::Table)
                .if_not_exists()
                .col(ColumnDef::new(File::Id).integer().auto_increment().primary_key())
                .col(ColumnDef::new(File::StoragePath).integer().not_null())
        ...
        tables.push(manager.create_table(
            Table::create()
                .table(Tag::Table)
                .if_not_exists()
                .col(ColumnDef::new(Tag::Id).integer().auto_increment().primary_key())
                .col(ColumnDef::new(Tag::Name).integer().not_null())
        ...
        tables.push(manager.create_table(
            Table::create()
                .table(Node::Table)
                .if_not_exists()
                .col(ColumnDef::new(Node::Id).integer().auto_increment().primary_key())
                ...
                .col(ColumnDef::new(Node::CreatedAt).timestamp_with_time_zone().not_null())
                ...
                .index(Index::create().name("idx_node_snippet_id").col(Node::SnippetId))
                .foreign_key(
                    ForeignKey::create()
        ...
        tables.push(manager.create_table(
            Table::create()
                .table(Snippet::Table)
                .if_not_exists()
                .col(ColumnDef::new(Snippet::Id).integer().auto_increment().primary_key())
                ...
                .col(ColumnDef::new(Snippet::CurrentHistoryId).string())
                .col(ColumnDef::new(Snippet::CreatedAt).timestamp_with_time_zone().not_null())
                .col(ColumnDef::new(Snippet::UpdatedAt).timestamp_with_time_zone().not_null())
                .index(Index::create().name("idx_snippet_connection_id").col(Snippet::ConnectionId))
                .index(Index::create().name("idx_snippet_current_history_id").col(Snippet::CurrentHistoryId))
                .index(Index::create().name("idx_snippet_updated_at").col(Snippet::UpdatedAt))
                .to_owned(),
        ).await?);
        ...
        tables.push(manager.create_table(
            Table::create()
                .table(History::Table)
                .if_not_exists()
                .col(ColumnDef::new(History::Id).integer().auto_increment().primary_key())
                ...
                .col(ColumnDef::new(History::CreatedAt).timestamp_with_time_zone().not_null())
                .col(ColumnDef::new(History::UpdatedAt).timestamp_with_time_zone().not_null())
                .index(Index::create().name("idx_history_snippet_id").col(History::SnippetId))
                .index(Index::create().name("idx_history_created_at").col(History::CreatedAt))
                .foreign_key(
                    ForeignKey::create()
        ...
        tables.push(manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(HistoryNode::CreatedAt).timestamp_with_time_zone().not_null())
                .primary_key(
                    Index::create()
                ...
                .index(Index::create().name("idx_history_node_node_id").col(HistoryNode::NodeId))
                .index(Index::create().name("idx_history_node_history_id").col(HistoryNode::HistoryId))
                .index(Index::create().name("idx_history_node_order").col(HistoryNode::HistoryId).col(HistoryNode::OrderIndex).unique())
                .foreign_key(
                    ForeignKey::create()
        ...
        tables.push(manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(SnippetTag::CreatedAt).timestamp_with_time_zone().not_null())
                .primary_key(
                    Index::create()
                        .name("pk-cake_baker")
